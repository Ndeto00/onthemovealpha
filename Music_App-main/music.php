...
<header>
    ...
    <div class="song_side">
        <nav>
            ...
            <div class="user">
                <img src="pexels-foteros-352505.jpg" alt="User" title="On the move">
            </div>
        </nav>
        <div class="content">
            <h1>Great Music &</h1>
            ...
            <h1>Worldwide</h1>
            <p>
                Gain access of music from various artists 
                <br>
                around the globe
            </p>
            <div class="buttons">
    ...
    <div class="master_play">
        ...
        <img src="img/9.jpg" alt="Sauti Sol" id="poster_master_play">
        <h5 id="title">Sura Yako<br>
            <div class="subtitle">Sauti Sol</div>
        </h5>
        <div class="icon">
